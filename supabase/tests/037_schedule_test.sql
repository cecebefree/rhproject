...
select set_config('request.jwt.claims',
  '{"sub":"ac87ccc1-2186-4c6b-aeb2-dd966032ee0e","role":"authenticated","tenant_id":"99999999-9999-9999-9999-999999999999","app_metadata":{"role":"student","tenant_id":"99999999-9999-9999-9999-999999999999"}}', true);
