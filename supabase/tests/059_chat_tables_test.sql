...
select set_config('request.jwt.claims', '{"sub":"11111111-1111-1111-1111-111111111111","tenant_id":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"}', true);
...
select set_config('request.jwt.claims', '{"sub":"22222222-2222-2222-2222-222222222222","tenant_id":"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"}', true);
...
select set_config('request.jwt.claims', '{"sub":"33333333-3333-3333-3333-333333333333","tenant_id":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"}', true);
