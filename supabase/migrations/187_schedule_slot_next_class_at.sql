-- Migration 187: schedule_slot.next_class_at
...
BEGIN
  ...
  v_effective_start := COALESCE(NEW.start_date, v_effective_start);
  v_effective_end   := COALESCE(NEW.end_date,   v_effective_end);
