    ...
    <BrowserRouter>
      ...
      <main id="main-content">
        <Routes>
          ...
          <Route path="/cambridge-curriculum" element={<PlaceholderPage title="Cambridge Curriculum" />} />
          ...
          <Route path="/social/student-council" element={<PlaceholderPage title="Student Council" />} />
          ...
          <Route path="/social/travel-outings" element={<PlaceholderPage title="Travel & Outings" />} />
          <Route path="/services/experts" element={<PlaceholderPage title="Experts" />} />
          <Route path="/services/university" element={<PlaceholderPage title="University Guidance" />} />
          ...
          <Route path="/schedule-meeting" element={<PlaceholderPage title="Schedule a Meeting" />} />
        </Routes>
      </main>
      <Footer />
    </BrowserRouter>
