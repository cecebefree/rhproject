...
const pillars = [
  {
    ...
    image: 'https://media.base44.com/images/public/69f23a2b0bbaf081e75813b0/7f4474889_logo.png/v1/fill/w_600,h_400/7f4474889_logo.png',
    ...
    <section className="py-20 md:py-32 bg-ivory" aria-labelledby="pillars-title">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 id="pillars-title" className="font-serif text-display-md font-semibold text-navy animate-fade-up stagger-1">
          ...
          <p className="font-sans text-body-lg text-charcoal-muted mt-6 animate-fade-up stagger-3">
            ...
            an education that is academically rigorous, personally nurturing, and globally connected.
          </p>
        </div>
            ...
            >
              <div className="relative h-48 md:h-56 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <p className="font-display text-champagne-light text-heading-sm">{pillar.subtitle}</p>
                </div>
              </div>
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-serif text-heading-lg font-semibold text-navy">{pillar.title}</h3>
                </div>
