...
- [ ] T012 Regenerate Supabase types: `supabase gen types typescript --local > packages/shared/src/types/database.ts`
- [ ] T013 Run `make test` to verify pgTAP tests pass for new tables
