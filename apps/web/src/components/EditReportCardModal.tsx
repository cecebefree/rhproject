...
export default function EditReportCardModal({
  isOpen,
  onClose,
  studentName,
  studentInitials,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div
        className="relative bg-white border rounded-lg w-full max-w-3xl max-h-[85vh] flex flex-col mx-4"
        style={{ borderColor: 'rgba(39,57,70,0.1)' }}
      >
        {/* Header */}
        <div
          className="px-8 py-6 flex items-start justify-between shrink-0"
          style={{ borderBottom: '1px solid rgba(39,57,70,0.1)', backgroundColor: '#F8F7F4' }}
        >
          <div>
            <h2
              style={{
          ...
          <div className="flex items-center gap-2">
            <div
              ...
              style={{
                backgroundColor: 'rgba(200,40,30,0.1)',
                border: '1px solid rgba(200,40,30,0.2)',
              }}
            >
              <span
                className="material-symbols-outlined"
                style={{ fontSize: '16px', color: '#C8281E' }}
              >
                calendar_today
              </span>
              <span
            ...
            >
              <span className="material-symbols-outlined" style={{ color: '#54626C' }}>
                close
              </span>
            </button>
          </div>
        ...
        <div className="p-8 overflow-y-auto flex-grow" style={{ backgroundColor: '#faf9f6' }}>
              ...
              {TERMS.map((term) => {
                ...
                return (
                  ...
                  >
                    ...
                    {term.status === 'submitted' && (
                      <span
                        className="ml-1 px-2 py-0.5 rounded uppercase"
                        style={{
                          fontSize: '10px',
                          fontWeight: 600,
                          letterSpacing: '0.12em',
                          backgroundColor: 'rgba(39,57,70,0.1)',
                          color: '#54626C',
                        }}
                      >
                        Submitted
          ...
          <div className="mb-8">
            <div className="flex justify-between items-end mb-3">
              ...
              <span style={{ fontSize: '12px', color: '#54626C' }}>
                {comment.length} / 1200 characters
              </span>
            </div>
            <div className="relative">
              ...
              />
              <div
                className="absolute bottom-4 right-4 flex gap-2 bg-surface-cream border rounded px-2 py-1 shadow-sm"
                style={{ borderColor: 'rgba(39,57,70,0.1)' }}
              >
                <button type="button"
                  className="p-1 hover:text-brand-navy"
                  style={{ color: '#54626C' }}
                  title="Bold"
                >
                  <span className="material-symbols-outlined" style={{ fontSize: '18px' }}>
                ...
                <div className="w-px mx-1 my-1" style={{ backgroundColor: 'rgba(39,57,70,0.1)' }} />
                <button type="button"
                  className="p-1 hover:text-brand-navy"
                  style={{ color: '#54626C' }}
                  title="Spellcheck"
          ...
          <div
            ...
            style={{ backgroundColor: '#F8F7F4', border: '1px solid rgba(39,57,70,0.05)' }}
          >
            <h3
            ...
            >
              Term {selectedTerm} Assessment Summary
            </h3>
            <div className="grid grid-cols-3 gap-6">
              <div>
                <span className="block mb-1" style={{ fontSize: '12px', color: '#54626C' }}>
                  Current Grade
                </span>
                <span
                  style={{ fontFamily: '"EB Garamond", serif', fontSize: '22px', color: '#273946' }}
                >
                  92%
                </span>
              </div>
        ...
        <div
          ...
          style={{
            borderTop: '1px solid rgba(39,57,70,0.1)',
        ...
        >
          <button type="button"
            ...
            style={{ color: '#54626C', fontSize: '14px' }}
          >
            <span className="material-symbols-outlined" style={{ fontSize: '18px' }}>
              history
            </span>
          ...
          <div className="flex gap-4">
            <button type="button"
              ...
              style={{ border: '1px solid #273946', color: '#273946', fontSize: '14px' }}
            >
              Save Draft
            </button>
            <button type="button"
              className="px-6 py-2 rounded transition-colors shadow-sm"
              style={{ backgroundColor: '#273946', color: '#ffffff', fontSize: '14px' }}
            >
              Submit Report
            </button>
          </div>
