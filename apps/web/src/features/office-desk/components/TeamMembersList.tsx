...
export function TeamMembersList({ deskId, currentUserId }: TeamMembersListProps) {
  const { members, roles, isLoading, error, removeMember, changeRole, refresh } = useTeamMembers({
    deskId,
  });
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: '14px', fontWeight: '500', color: '#2d3748' }}>
                  {userName}
                  {isCurrentUser && (
                    <span style={{ color: '#a0aec0', fontWeight: '400' }}> (you)</span>
                  )}
                </div>
