          ...
          <>
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">
                You are about to soft delete {selectedIds.size} {entityTypeLabel}. They will be
                hidden from your list but can be restored within 30 seconds.
              </p>
          ...
          <div className="p-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-yellow-800">
                You have <strong>30 seconds</strong> to undo this operation. After that, the records
