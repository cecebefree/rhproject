...
const STAFF_DATA: Record<
  string,
  {
    ...
    clubs: { name: string; dayTime: string; students: string[] }[];
...
> = {
  'dr-e-vance': {
    ...
    staffType: 'Teacher',
    dob: '15 Mar 1978',
    registrationYearAge: '46',
    enrollmentDate: '01 Sep 2010',
    yearsEnrolled: '13 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
      ...
      },
      {
        ...
        grades: 'Grade 9',
        curriculum: 'Cambridge',
        students: ['Theodore Montgomery', 'Eleanor Montgomery'],
      },
    ],
    clubs: [{ name: 'Chess Club', dayTime: 'Wed 15:30', students: ['Theodore Montgomery'] }],
    enrichmentCourses: [{ name: 'AI & Robotics', level: 'Senior Level', status: 'Active' }],
    groups: [{ name: 'Senior Group', type: 'Academic', status: 'Active' }],
  },
  'mr-a-sterling': {
    firstName: 'Mr. A.',
    lastName: 'Sterling',
    ...
    staffType: 'Teacher',
    dob: '22 Jul 1982',
    registrationYearAge: '42',
    enrollmentDate: '01 Sep 2012',
    yearsEnrolled: '11 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
  ...
  'mrs-h-lin': {
    ...
    staffType: 'Teacher',
    dob: '08 Nov 1980',
    registrationYearAge: '43',
    enrollmentDate: '01 Sep 2011',
    yearsEnrolled: '12 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
  ...
  'mr-d-miller': {
    ...
    staffType: 'Teacher',
    dob: '30 Jan 1975',
    registrationYearAge: '49',
    enrollmentDate: '01 Sep 2008',
    yearsEnrolled: '15 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
        subject: 'History & Global Perspectives',
        stage: 'Senior School',
        grades: 'Grade 9',
        curriculum: 'Cambridge',
        students: ['Theodore Montgomery'],
    ...
    clubs: [{ name: 'Varsity Soccer', dayTime: 'Mon 16:00', students: ['Theodore Montgomery'] }],
    enrichmentCourses: [],
    groups: [],
  },
  'ms-s-patel': {
    ...
    staffType: 'Teacher',
    dob: '17 Jun 1988',
    registrationYearAge: '36',
    enrollmentDate: '01 Sep 2016',
    yearsEnrolled: '7 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
    ...
    clubs: [{ name: 'Drama Society', dayTime: 'Thu 16:30', students: ['Theodore Montgomery'] }],
    enrichmentCourses: [],
    groups: [],
  },
  'mrs-j-wright': {
    ...
    staffType: 'Teacher',
    dob: '05 Sep 1983',
    registrationYearAge: '40',
    enrollmentDate: '01 Sep 2013',
    yearsEnrolled: '10 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
        subject: 'Art & Visual Culture',
        stage: 'Senior School',
        grades: 'Grade 9',
        curriculum: 'Cambridge',
        students: ['Theodore Montgomery'],
  ...
  'mr-j-thompson': {
    ...
    initials: 'JT',
    staffId: 'STF-1108-H',
    staffType: 'Wellness Coach',
    dob: '12 Apr 1979',
    registrationYearAge: '45',
    enrollmentDate: '01 Sep 2009',
    yearsEnrolled: '14 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
        subject: 'Wellness Coach',
        stage: 'Senior School',
        grades: 'Grade 9',
        curriculum: 'Cambridge',
        students: ['Theodore Montgomery'],
  ...
  'sarah-r': {
    ...
    staffType: 'Teacher',
    dob: '12 Oct 1985',
    registrationYearAge: '38',
    enrollmentDate: '01 Sep 2015',
    yearsEnrolled: '8 Years',
    mainZone: 'Senior Campus',
    status: 'Active',
    classes: [
      {
        subject: 'Physics HL',
        stage: 'Senior School',
        grades: 'Multi (10, 11, 12)',
        curriculum: 'IB Diploma',
        students: ['Theodore Montgomery', 'Eleanor Montgomery', 'Eleanor Vance'],
      },
      {
        ...
        grades: 'Multi (10, 11, 12)',
        curriculum: 'IB Diploma',
        students: ['Julian Sorel', 'Dorian Gray'],
      },
    ],
    clubs: [
      {
        name: 'Varsity Soccer',
        dayTime: 'Mon 16:00',
        students: ['Theodore Montgomery', 'Julian Sorel'],
      },
      { name: 'Chess Club', dayTime: 'Wed 15:30', students: ['Eleanor Montgomery'] },
      {
        name: 'Drama Society',
        dayTime: 'Thu 16:30',
        students: ['Emma Woodhouse', 'Theodore Montgomery'],
      },
    ],
    enrichmentCourses: [
...
export default function StaffProfilePage() {
  ...
  const [editReportStudent, setEditReportStudent] = useState({
    name: '',
    initials: '',
    grade: '',
    subject: '',
  ...
  const contactActivities = [
    {
      ...
      description: 'Annual contract renewed for 2024 academic year.',
      timestamp: '01 Sep 2023',
    },
    {
      type: 'attendance' as const,
      label: 'TRAINING COMPLETE',
      description: 'First Aid Certification completed. Valid until Dec 2024.',
      timestamp: '15 Jul 2023',
    },
  ];
  ...
  const handleEditReportCard = (student: {
    name: string;
    initials: string;
    grade: string;
    subject?: string;
  ...
  return (
    <AdminLayout activeDesk="crm">
      ...
      <div className="flex items-center gap-2 text-sm mb-6">
        <Link to="/service/crm" className="hover:underline" style={{ color: '#54626C' }}>
          CRM
        </Link>
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-6">
          <div
            className="w-24 h-24 rounded-full border-2 p-1 flex items-center justify-center"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div
          ...
          style={{ backgroundColor: '#ffffff', border: '1px solid rgba(39,57,70,0.1)' }}
        >
          <div
            className="flex items-center justify-between pb-4"
            style={{ borderBottom: '1px solid rgba(39,57,70,0.05)' }}
          >
            <h3
              style={{
                fontFamily: '"EB Garamond", serif',
            ...
            <span className="material-symbols-outlined" style={{ color: '#73777c' }}>
              badge
            </span>
          </div>
          <div className="grid grid-cols-2 gap-y-6 gap-x-4">
            {[
              ...
              <div key={item.label}>
                ...
                <div
                  className="mt-1"
                  style={{ height: '1px', backgroundColor: 'rgba(39,57,70,0.1)' }}
                />
              </div>
            ))}
          </div>
        ...
        >
          <div className="absolute -right-12 -top-12 opacity-5 pointer-events-none">
            ...
            >
              ...
              <path
                d="M12 3L1 9L12 15L21 10.09V17H23V9L12 3ZM12 17.18L5 13.36V16.18L12 20L19 16.18V13.36L12 17.18Z"
                fill="currentColor"
              />
            </svg>
          </div>
      ...
      >
        ...
        >
          ...
          <button type="button"
            className="px-4 py-2 rounded flex items-center gap-2 transition-colors cursor-pointer"
            style={{
              border: '1px solid rgba(39,57,70,0.2)',
              color: '#273946',
              fontSize: '11px',
              letterSpacing: '0.12em',
              fontWeight: 600,
        ...
        <div className="w-full">
          <div
            className="grid grid-cols-12 gap-4 pb-2 uppercase"
            style={{
              borderBottom: '1px solid rgba(39,57,70,0.1)',
              fontSize: '11px',
              letterSpacing: '0.12em',
              fontWeight: 600,
              color: '#54626C',
          ...
          <div className="divide-y" style={{ borderColor: 'rgba(39,57,70,0.05)' }}>
            {staff.classes.map((cls) => (
              <div
                key={cls.subject}
                className="grid grid-cols-12 gap-4 py-4 items-center hover:bg-surface-cream transition-colors"
                style={{ borderColor: 'rgba(39,57,70,0.05)' }}
              >
                <div
                  className="col-span-3 flex items-center gap-3"
                  style={{ fontSize: '14px', color: '#1A242B' }}
                >
                  <span
                    className="px-2 py-1 rounded"
                    style={{ backgroundColor: '#f4f3f0', color: '#273946', fontSize: '12px' }}
                  >
                    {cls.subject}
                  </span>
                </div>
                <div className="col-span-3" style={{ fontSize: '12px', color: '#54626C' }}>
                  {cls.stage}
                </div>
                <div className="col-span-2" style={{ fontSize: '12px', color: '#54626C' }}>
                  {cls.grades}
                </div>
                <div
                  className="col-span-2 text-right"
                  style={{ fontSize: '12px', color: '#54626C' }}
                >
                  {cls.curriculum}
                </div>
      ...
      {/* Report Card & Exams */}
      <div
        className="rounded-xl p-12 flex flex-col gap-6"
        style={{ backgroundColor: '#ffffff', border: '1px solid rgba(39,57,70,0.1)' }}
      >
        <div
          className="flex items-center justify-between pb-4"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="pl-8" style={{ borderLeft: '1px solid rgba(39,57,70,0.05)' }}>
            ...
            <div className="space-y-6">
              <div className="mb-6">
                <span
                  className="mb-3 uppercase block"
                  style={{
                    fontSize: '11px',
                    letterSpacing: '0.12em',
                    fontWeight: 600,
                ...
                <div
                  className="flex items-center gap-4 p-4 rounded cursor-pointer transition-colors"
                  style={{ backgroundColor: 'rgba(39,57,70,0.05)' }}
                >
                  <div
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ fontSize: '10px', color: '#54626C', letterSpacing: '0.1em' }}
                    >
                      Updated Oct 2023
                    </p>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <p style={{ fontSize: '14px', color: '#54626C' }}>
                  Integrated performance tracking from LMS data, class attendance, and report cards.
                </p>
                <button type="button"
                ...
                <div style={{ height: '1px', backgroundColor: 'rgba(39,57,70,0.1)' }} />
              </div>
              <div className="mt-6">
                <span
                  className="block mb-1 uppercase"
          ...
          <div className="divide-y" style={{ borderColor: 'rgba(39,57,70,0.05)' }}>
            {staff.clubs.map((club) => (
              ...
              >
                ...
                <div className="col-span-4" style={{ fontSize: '12px', color: '#54626C' }}>
                  {club.dayTime}
                </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                className="ml-2"
                style={{ fontSize: '16px', color: '#54626C', fontWeight: 400 }}
              >
                ({staff.enrichmentCourses.length})
              </span>
            </h3>
            <span className="material-symbols-outlined" style={{ color: '#73777c' }}>
              history_edu
                ...
                {staff.enrichmentCourses.map((course) => (
                  ...
                  >
                    <div className="flex flex-col">
                      <div className="font-medium" style={{ fontSize: '14px', color: '#1A242B' }}>
                        {course.name}
                      </div>
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-8">
          <div>
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#273946' }} />{' '}
              Active
            </div>
            <div
              className="mt-2"
          ...
          <div>
            ...
            <button type="button"
              ...
              style={{ color: '#273946', fontSize: '16px', fontWeight: 500 }}
            >
              View Contract{' '}
          ...
          <div>
            ...
            <div style={{ fontSize: '16px', color: '#1A242B', fontFamily: 'monospace' }}>
              PR-9928-X
            </div>
            <div
              className="mt-2"
        ...
        <div
          ...
          style={{ borderTop: '1px solid rgba(39,57,70,0.05)' }}
        >
          <button type="button"
