  ...
  const contactActivities = [
    {
      ...
      description: 'Marked Late (Excused) for 1st Period by Front Desk.',
      timestamp: 'Today, 09:15 AM',
    },
    {
      type: 'disciplinary' as const,
      label: 'DISCIPLINARY LOG',
      description: 'Minor uniform infraction. Noted by Mr. Sterling.',
      timestamp: 'Yesterday',
    },
    {
      type: 'medical' as const,
      label: 'MEDICAL RECORD UPDATE',
      description: 'Annual physical form uploaded by Parent Portal.',
  ...
  return (
    <AdminLayout activeDesk="crm">
      ...
      <div className="flex items-center gap-2 text-sm mb-6">
        ...
        <Link
          to={`/service/crm/family/${familyId}`}
      ...
      >
        ...
        <div className="w-full">
          ...
          <div className="divide-y" style={{ borderColor: 'rgba(39,57,70,0.05)' }}>
            {s.classes.map((cls) => (
              <div
                key={cls.subject}
                className="grid grid-cols-12 gap-4 py-4 items-center transition-colors"
              ...
              >
                ...
                >
                  ...
                  <Link
                    to={`/service/staff/${cls.staff.toLowerCase().replace(/\s+/g, '-').replace(/\./g, '')}`}
                    className="hover:underline"
                    style={{ color: '#273946' }}
                  >
                    {cls.staff}
        ...
        <div
          className="mt-6 pt-6 flex gap-6"
          style={{ borderTop: '1px solid rgba(39,57,70,0.05)' }}
        >
          <button type="button"
            className="flex items-center gap-2 hover:underline"
            style={{ color: '#273946', fontSize: '11px', letterSpacing: '0.12em', fontWeight: 600 }}
          >
            <span className="material-symbols-outlined" style={{ fontSize: '18px' }}>
              history
            </span>{' '}
          ...
          <button type="button"
            className="ml-auto px-4 py-2 rounded flex items-center gap-2 transition-colors cursor-pointer"
            style={{
              border: '1px solid rgba(39,57,70,0.2)',
              color: '#273946',
              fontSize: '11px',
        ...
        {selectedReportCard ? (
          ...
          <div className="flex flex-col gap-6">
            ...
            <div
              ...
              style={{ borderBottom: '1px solid rgba(39,57,70,0.1)' }}
            >
              <div
                className="w-20 h-20 rounded-full border-2 p-1 flex items-center justify-center"
                style={{ borderColor: '#E8A020', backgroundColor: '#273946' }}
              >
                <div
                  className="w-full h-full rounded-full flex items-center justify-center"
              ...
              <div className="text-right">
                ...
                >
                  Report Card - {selectedReportCard}
                </div>
                <div style={{ fontSize: '11px', color: '#54626C', letterSpacing: '0.12em' }}>
                  Date: Oct 15, 2023
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-1">
              {['Cultural Input', 'Cultural Output'].map((tab) => (
                <button type="button"
                  ...
                  style={{
                    backgroundColor: tab === 'Cultural Input' ? '#273946' : '#e9e8e5',
                    color: tab === 'Cultural Input' ? '#ffffff' : '#54626C',
                    fontSize: '11px',
                    letterSpacing: '0.12em',
                    fontWeight: 600,
                  }}
                ...
                {s.classes.map((cls) => (
                  ...
                  >
                    <div
                      ...
                      style={{ fontSize: '13px', color: '#1A242B', fontWeight: 500 }}
                    >
                      {cls.subject}
                    </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                {s.reportCards.map((rc) => (
                  <div
                    key={rc.term}
                    className={`flex flex-col items-center gap-2 ${!rc.available ? 'opacity-40 grayscale' : rc.term === selectedReportCard ? 'ring-2 ring-offset-2' : 'cursor-pointer group'}`}
                    style={rc.term === selectedReportCard ? { borderColor: '#E8A020' } : {}}
                  >
                    <div
                      className="w-14 h-14 rounded flex items-center justify-center transition-colors"
                      style={{
                        backgroundColor:
                          rc.term === selectedReportCard
                            ? '#273946'
                            : rc.available
                              ? 'rgba(39,57,70,0.05)'
                              : '#e3e2df',
              ...
              <div className="divide-y" style={{ borderColor: 'rgba(39,57,70,0.05)' }}>
                {s.clubs.map((club) => (
                  ...
                  >
                    ...
                    <div className="col-span-2 text-right">
                      <Link
                        to={`/service/staff/${club.staff.toLowerCase().replace(/\s+/g, '-').replace(/\./g, '')}`}
                        className="hover:underline"
                        style={{
                          color: '#273946',
                          fontSize: '11px',
            ...
            <div>
              ...
              <div className="flex gap-4 mb-6 p-4">
                {s.reportCards.map((rc) => (
                  <div
                    key={rc.term}
                    className={`flex flex-col items-center gap-2 ${!rc.available ? 'opacity-40 grayscale' : 'cursor-pointer group'}`}
                    onClick={() => rc.available && setSelectedReportCard(rc.term)}
                    onKeyPress={(e) => { if ((e.key === 'Enter' || e.key === ' ') && rc.available) { e.preventDefault(); setSelectedReportCard(rc.term); } }}
                  >
                    <div
                      className="w-12 h-12 rounded flex items-center justify-center transition-colors"
                      style={{
                        backgroundColor: rc.available ? 'rgba(39,57,70,0.05)' : '#e3e2df',
                        color: rc.available ? '#273946' : '#54626C',
                      }}
                    >
                      <span className="material-symbols-outlined">
                        {rc.available ? 'description' : 'lock'}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p style={{ fontSize: '14px', color: '#54626C' }}>
                    Integrated performance tracking from LMS data, class attendance, and report
                    cards.
                  </p>
                  <button type="button"
      ...
      >
        ...
        >
          ...
          >
            Clubs
            <span className="ml-2" style={{ fontSize: '16px', color: '#54626C', fontWeight: 400 }}>
              ({s.clubs.length})
            </span>
          </h3>
          <button type="button"
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-8">
          <div>
            ...
            <a
              href={`/service/crm/family/${familyId}`}
              className="font-medium hover:underline"
              style={{ color: '#273946' }}
            >
              {s.familyId}
          ...
          <div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <span style={{ fontSize: '12px', color: '#E8A020', fontWeight: 700 }}>
                Status: On Track
              </span>
            </div>
          </div>
