...
export type Database = {
    ...
    Tables: {
      ...
      failed_enrollments: {
        Row: {
          ...
          payment_attempt: Json
          payment_provider: string | null
          payment_reference: string | null
          registration_attempt: Json
      ...
      invoices: {
        ...
        Relationships: [
          {
            foreignKeyName: "invoices_family_account_id_fkey"
      ...
      payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "payments_family_account_id_fkey"
            columns: ["family_account_id"]
            isOneToOne: false
            referencedRelation: "family_accounts"
            referencedColumns: ["id"]
  ...
  public: {
    ...
    Functions: {
      ...
      execute_debit_order: {
        Args: { p_debit_order_id: string; p_status?: string }
        Returns: {
          payment_id: string
          status: string
        }[]
      ...
      get_financial_summary: { Args: { p_tenant_id?: string }; Returns: Json }
      get_lead_pipeline: {
        Args: never
        Returns: {
      ...
      sign_contract: {
        Args: { p_contract_id: string; p_signed_by?: string }
        Returns: {
          status: string
        }[]
      }
    ...
    Tables: {
      ...
      gradebook: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "gradebook_program_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
    ...
    Views: {
      courses: {
        Row: {
          ...
          description: string | null
          id: string | null
          open_to_outside: boolean | null
          platform: Database["public"]["Enums"]["platform_key"] | null
          price: number | null
          status: string | null
